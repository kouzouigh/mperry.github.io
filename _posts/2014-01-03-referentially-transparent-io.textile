...
Now that we have the _interactiveStream_ function returning a single SimpleIO to do the main interactive loop, the entire REPL and main program can be defined as:
