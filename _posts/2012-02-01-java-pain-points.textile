...
** date, time and datetime representations
** tuples, options
...
These three type of theorems are not well integrated in programming languages (presenting research opportunities).
...
The Java type system is a hodge-podge of different abstractions that lacks an elegant, unified model.  You need to work with arrays, classes and primitives.  Compare this to Scala's type system !>http://www.scala-lang.org/sites/default/files/images/classhierarchy.img_assist_custom.png!.  Java arrays are a pain to work with and are unfortunately covariant.  Primitves have to be boxed and unboxed and interact strangely with var args and generics.  Ugly!
...
bq.:http://en.wikipedia.org/wiki/Lazy_evaluation
