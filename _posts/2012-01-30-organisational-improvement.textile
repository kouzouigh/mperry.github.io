---
layout: post
title: Making the Case for Organisational Improvement
keywords: process improvement, software process improvement, SPI, change, strategy, management, proposal
description: Making the strategic and tactical case for organisational process improvement
tags:
  - post:type=process improvement
---

Many engineers feel debilitated and enfeebled by autocratic managers, lacking the power and authority to make meaningful changes to their development practices.  Assuming you can get some management support for the idea of organisational improvement and get their ear, how do you make the strategic and tactical case for improvement?  Regardless of the change proposed (process, language, tool, etc) the generic case for improvement of any type consists of:
...
h2.  Understand the business environment

The case must depend and reflect the business environment and the current priorities.  Learn what is happenning in the business.  If the business just lost a major customer, obviously now may not be a good time to propose an expense, regardless of the perceived benefits.

h2.  Identify the hot buttons
