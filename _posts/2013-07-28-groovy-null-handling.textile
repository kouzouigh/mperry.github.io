---
layout: post
title: Groovy Null Handling Using Bind, Comprehensions and Lift
keywords: Groovy FunctionalJava Java null Monad FunctionalGroovy lift comprehension Functor functional programming FP bind comprehension lift
description:
tags:
---
...
h1. Simple Functional Java Examples

The page "Functional Progamming with Groovy":http://groovy.codehaus.org/Functional+Programming+with+Groovy first lists some simple List processing using FJ (Functional Java) and Groovy.  This requires meta-programming to add new methods to the existing FJ classes.
...
fn1. "FunctionalGroovy":https://github.com/mperry/functionalgroovy

fn2. "FunctionalJava":http://functionaljava.org/

fn3. "Scala For Comprehension":https://adamwojtuniak.wordpress.com/2010/09/24/scala-for-comprehensions/

fn4. "Functional Scala, Comprehending Comprehensions":https://gleichmann.wordpress.com/2010/11/21/functional-scala-comprehending-comprehensions/

fn5. "Haskell List Comprehensions":http://www.haskell.org/haskellwiki/List_comprehension

fn6. "Null References, The Billion Dollar Mistake":http://www.infoq.com/presentations/Null-References-The-Billion-Dollar-Mistake-Tony-Hoare

fn7. "Option Type":http://en.wikipedia.org/wiki/Option_type
