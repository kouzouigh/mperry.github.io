...
Options - The type containing no value or one value.  Nulls are commonly used to represent the Option type in object oriented languages.  Tony Hoare has talked about this being his "billion dollar mistake":http://www.infoq.com/presentations/Null-References-The-Billion-Dollar-Mistake-Tony-Hoare.

<object id="player" width="320" height="265" type="application/x-shockwave-flash" data="http://d1snlc0orfrhj.cloudfront.net/static/flash/svmplayer.swf" style="visibility: visible;">
<param name="allowscriptaccess" value="always">
<param name="allowfullscreen" value="true">
<param name="wmode" value="opaque">
<param name="flashvars" value="server=rtmpe://video.infoq.com/cfx/st/&streams=flv:presentations/09-mar-nullreferences,0">
</object>
