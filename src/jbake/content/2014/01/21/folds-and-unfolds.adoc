...
Trampolines have proven useful to me numerous times to avoid overflowing the stack, e.g. when performing link:../../../2014/01/03/referentially-transparent-io.html[referentially transparent IO].
