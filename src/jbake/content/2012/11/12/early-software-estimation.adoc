...
Initial software size can be performed by category or analogy.  See my previous post on link:../../../2012/01/02/software-estimation.html[Fast Software Sizing]
